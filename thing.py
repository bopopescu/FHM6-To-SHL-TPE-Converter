...
class Player:
    def __init__(self, raw_data):
        self.attributes = {'first_name': raw_data[0], 'last_name': raw_data[1], 'Team Name': raw_data[60],
                           ...
                           'Getting Open': raw_data[26], 'Passing': raw_data[26], 'Puck Handling': raw_data[28],
                           ...
                           'Reflexes': raw_data[49], 'Skating': raw_data[50]}
...
def main():
    ...
    with open('player.txt', 'w+') as file:
        ...
        for x in myresult:
            player = Player(x)
            count += 1
            file.write(str(player.attributes) + '\n')
