...
def main():
    ...
    mycursor.execute("SELECT fhm6.player_main.`First Name`, fhm6.player_main.`Last Name`, fhm6.player_ratings.*, fhm6.team_data.Name, fhm6.team_data.Nickname, fhm6.league_data.Name AS Expr1 \
                      FROM fhm6.player_ratings \
                      INNER JOIN fhm6.player_main \
                        ON fhm6.player_ratings.PlayerId = fhm6.player_main.PlayerId \
                          INNER JOIN fhm6.team_data \
                            ON fhm6.player_main.TeamId = fhm6.team_data.TeamId \
